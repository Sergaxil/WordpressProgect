...
<div class="main-menu">
            <div class="main-menu-block">
                    <!-- Menu Header Bottom -->
                <?php if(has_nav_menu( 'header_bottom_menu' )){
                    wp_nav_menu( array(
                        'theme_location' => 'header_bottom_menu', 
                        'menu' => 'Header Bottom Menu',
                        'menu_class' => 'first menu-bottom',
                        'container' => '',

                        ));
                    }?>
                </div>
                <div class="main-menu-cach">
                    <a title="Посмотреть корзину" href="..quick-order/">
                        <span class="cash-span">Корзина:</span>
                        <span class="product">
                            0.00
                        </span>
                    </a>
